            ...
            <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
                ...
                <div class="row">
                    <div class="col-md-12 col-12 mb-20">
                        ...
                        <input  name="eskisifre" required="" class="mb-0" type="password" placeholder="Eski şifreyi girin.">
                    </div>
                    <div class="col-12 mb-20">
                        <label>Yeni şifre</label>
                        <input minlength="8" name="yenisifre" required="" class="mb-0" type="password" placeholder="yeni şifreyi giriniz.">
                    </div>
                    <div class="col-12 mb-20">
                        <label>Yeni şifre tekrar</label>
                        <input minlength="8" name="yenitekrar" required="" class="mb-0" type="password" placeholder="yeni şifreyi tekrar  giriniz.">
                    </div>
