           <!-- Begin Footer Area -->
           <div class="footer" style="background-color:black; opacity: 0.9;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                <div class="li-shipping-inner-box">
                                    ...
                                    <div class="shipping-text">
                                        ...
                                        <p>Tüm Türkiye içine ücretsiz kargo</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                <div class="li-shipping-inner-box">
                                    ...
                                    <div class="shipping-text">
                                        <h2>Güvenli Ödeme</h2>
                                        <p>Güvenli bir şekilde ödemenizi tamamlayınız.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Li's Shipping Inner Box Area End Here -->
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                <div class="li-shipping-inner-box">
                                    ...
                                    <div class="shipping-text">
                                        <h2>Uygun Fiyat</h2>
                                        <p>Uygun fiyat, hesaplı ürünlerden dilediğinizi alın.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Li's Shipping Inner Box Area End Here -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="footer-logo">
                                    <img width="200" src="Admin/resimler/logo/<?php echo $ayarcek['logo'] ?>" alt="Footer Logo">
                                    <p class="info">
                            ...
                            <div class="footer-block">
                                ...
                                <ul>
                                    ...
                                    while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <li><a href="urunler-<?=seo($kategoricek['kategori_ad']).'-'.$kategoricek['kategori_id'] ?>?sayfa=1">




                                            <?php echo $kategoricek['kategori_ad'] ?> </a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <form action="islem" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="footer-subscribe-form validate" target="_blank" novalidate>
                                     <div id="mc_embed_signup_scroll">
                                      <div id="mc-form" class="mc-form subscribe-form form-group" >
                                        <input  type="email" name="abone" placeholder="E-Mail Giriniz" />
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="copyright text-center pt-25">
                        <span class="text-white">Kadir YOLCU 2021</span>
                    </div>
...
<script type="text/javascript"> (function ()
   { var options = {
       ...
       whatsapp: "+90numaranız",
       call_to_action: "Whatsapp'tan sor ?",
       position: "left",
