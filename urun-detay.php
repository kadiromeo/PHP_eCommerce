...
?>
<title><?php $urunlercek['urun_baslik']; ?></title>
               ...
               <div class="product-details-left">
                <div class="product-details-images slider-navigation-1">
                    ...
                    while  ($cokluresimcek = $cokluresim ->fetch(PDO::FETCH_ASSOC)){ ?>
                        ...
                        <div class="lg-image">
                            <img  style="width: 400px;" src="Admin/resimler/cokluresim/<?php echo $cokluresimcek['resim'] ?>" alt="product image">
                        </div>
                ...
                while  ($cokluresimcek = $cokluresim ->fetch(PDO::FETCH_ASSOC)){ ?>
                    <div class="sm-image"><img  src="Admin/resimler/cokluresim/<?php echo $cokluresimcek['resim'] ?>" alt="product image thumb"></div>
                <?php } ?>
            </div>
        </div>
        <!--// Product Details Left -->
     ...
     <div class="product-details-view-content sp-normal-content pt-60 ">
        ...
        <div class="product-additional-info">
            <div class="product-social-sharing">
                <ul>
                    <li class="facebook"><a href="<?php echo $ayarcek['facebook'] ?>"><i class="fa fa-facebook"></i>Facebook</a></li>
                    <li class="twitter"><a href="<?php echo $ayarcek['twitter'] ?>"><i class="fa fa-twitter"></i>Twitter</a></li>
                    <li class="youtube"><a href="<?php echo $ayarcek['youtube'] ?>"><i class="fa fa-google-plus"></i>YouTube</a></li>
                    <li class="instagram"><a href="<?php echo $ayarcek['instagram'] ?>"><i class="fa fa-instagram"></i>Instagram</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row ">
            <div class="col-lg-12">
                ...
                <i class="alert-success"> <?php 

                if (@$_GET['yuklenme']=='basarili') { ?>
                Yorum yapma başarılı</i>
            <?php } elseif (@$_GET['yuklenme']=='basarisiz') {?>  
             <i class="alert-danger">  Yorum yapma başarısız   <?php     } ?>
    ...
    <div id="reviews" class="tab-pane" role="tabpanel">
        <div class="product-reviews">
            <div class="product-details-comment-block">
                ...
                while  ($yorumlarcek = $yorumlar ->fetch(PDO::FETCH_ASSOC)){ ?>
                    ...
                    <div class="comment-author-infos pt-25">
                     <span > <?php      echo $kullanicilarcek['kullanici_ad']; ?>
                 </span>
                 <em class="text-black"><?php echo $yorumlarcek['yorum_detay'] ?></em>
         ...
         <div class="review-btn">
            <a class="review-links" href="#" data-toggle="modal" data-target="#mymodal">Yorumunu Yaz!</a>
        </div>
                                            ...
                                            <form action="Admin/islem/islem.php" method="post">
                                                ...
                                                <div class="feedback-input">
                                                    ...
                                                    <div class="feedback-btn pb-15">
                                                        <a style="float:right" href="#" class="close" data-dismiss="modal" aria-label="Close">Çıkış</a>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="urun-detay-<?=seo($urunlercek['urun_baslik']).'-'.$urunlercek['urun_id'] ?>">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <h4><a class="product_name" href="urun-detay-<?=seo($urunlercek['urun_baslik']).'-'.$urunlercek['urun_id'] ?>"><?php echo $urunlercek['urun_baslik'] ?></a></h4>
                                        <div class="price-box">
                                            <span class="new-price new-price-2"><?php echo $urunlercek['urun_fiyat'] ?>₺</span>
                                        </div>
                                    </div>
                                              <!--
                                                 <div class="add-actions">
                                                    ...
                                                    <div class="add-actions">
                                                        <ul class="add-actions-link">
                                                            <li class="add-cart active"><a href="urun-detay-<?=seo($urunlercek['urun_baslik']).'-'.$urunlercek['urun_id'] ?>">Detaya Git</a></li>
