                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="li-product-quantity">Siparişi Güncelle</th>
                            ...
                            <tbody>
                                ...
                                while ($sipariscek = $siparis ->fetch(PDO::FETCH_ASSOC)) {
                                  ...
                                  <tr>
                                    ...
                                    <td class="li-product-thumbnail"><a href="#"><img width="100" src="Admin/resimler/urunler/<?php echo $urunlercek['urun_resim'] ?>" alt="Li's Product Image"></a></td>
                                    ...
                                    <td class="li-product-price">
                                      ...
                                      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          ...
                                          <div class="modal-body">
                                            Eğer siparişinizi verdikten 24 saat geçmedi ise bu siparişi güncelleyebilirsiniz.
                                            Ama eğer 24 saat geçti ise, kargoya çıkacağından dolayı güncelleyemezsiniz.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Kapat</button>
                                            <a href="siparisguncelle"><button type="button" class="btn btn-outline-second">Siparişimi Güncelle</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
